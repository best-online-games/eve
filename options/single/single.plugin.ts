namespace $.$$ {
	...
	/**
	 * Plugin for single-selection option groups.
	 * 
	 * Provides common behavior for radio_group, segmented, and tab_group.
	 * Mixes into any component that needs single-selection logic.
	 * 
	 * @example
	 * ```tree
	 ...
	 * ```
	 */
	export class $eve_options_single_plugin extends $mol_plugin {
