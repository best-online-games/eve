...
declare namespace $ {
	...
	export class $eve_surface extends $mol_view {
		colors( next?: any ): any
...
declare namespace $.$$ {
    type $eve_surface_color = typeof $eve_surface.COLORS[number];
    type $eve_surface_color_surface_level = typeof $eve_surface.COLORS_SURFACE_LEVELS[number];
    type $eve_surface_color_brand = typeof $eve_surface.COLORS_BRAND[number];
    type $eve_surface_size = typeof $eve_surface.SIZES[number];
    type $eve_surface_state_modifiers = typeof $eve_surface.STATE_MODIFIERS[number];
    type $eve_surface_variant = typeof $eve_surface.VARIANTS[number];
    class $eve_surface extends $.$eve_surface {
        static readonly STATE_MODIFIERS: readonly ["enabled", "hovered", "pressed", "disabled", "loading"];
        static readonly COLORS_BRAND: readonly ["primary", "secondary", "tertiary", "danger", "warning", "success", "info"];
...
declare namespace $.$$ {
    ...
    function get_token_surface_property(property: string): string;
    function var_token(token: string, fallback?: string): string;
}

declare namespace $ {

	export class $eve_page extends $mol_page {
	}
...
declare namespace $ {
	...
	type $eve_app_page_sb_playground__component_name_eve_app_page_components_button_1 = $mol_type_enforce<
		...
		ReturnType< $eve_app_page_sb_playground['component_name'] >
	>
	type $eve_app_page_sb_playground__default_source_eve_app_page_components_button_2 = $mol_type_enforce<
		string
		,
		ReturnType< $eve_app_page_sb_playground['default_source'] >
	>
...
declare namespace $ {
	...
	type $eve_app_page_sb_catalog__param_eve_app_page_components_1 = $mol_type_enforce<
		...
		ReturnType< $eve_app_page_sb_catalog['param'] >
	>
	type $eve_app_page_sb_catalog__menu_filter_enabled_eve_app_page_components_2 = $mol_type_enforce<
		boolean
		,
		ReturnType< $eve_app_page_sb_catalog['menu_filter_enabled'] >
	>
...
//# sourceMappingURL=components.view.tree.d.ts.map
declare namespace $.$$ {
    class $eve_app_page_components extends $.$eve_app_page_components {
        ...
        grid_header_text(state: string): string;
        grid_row_text(color: string): string;
        Grid_cell(id: string): $eve_surface;
    }
}
...
//# sourceMappingURL=design.view.tree.d.ts.map
declare namespace $.$$ {
...
declare namespace $ {
	...
	type $mol_string__value_eve_app_color_1 = $mol_type_enforce<
		ReturnType< $eve_app_color['value'] >
		,
		ReturnType< $mol_string['value'] >
	>
	type $mol_view__attr_eve_app_color_2 = $mol_type_enforce<
		({ 
			'type': string,
		}) 
		,
		ReturnType< $mol_view['attr'] >
	>
	type $mol_view__dom_name_eve_app_color_3 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_view['dom_name'] >
	>
	type $mol_view__event_eve_app_color_4 = $mol_type_enforce<
		({ 
			input( next?: ReturnType< $eve_app_color['picker_input'] > ): ReturnType< $eve_app_color['picker_input'] >,
		}) 
		,
		ReturnType< $mol_view['event'] >
	>
	type $mol_view__sub_eve_app_color_5 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	export class $eve_app_color extends $mol_view {
		Input( ): $mol_string
...
declare namespace $ {
	...
	type $mol_button_minor__title_eve_app_demo_1 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_minor['title'] >
	>
	type $mol_button_minor__title_eve_app_demo_2 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_minor['title'] >
	>
	type $mol_dimmer__haystack_eve_app_demo_3 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_dimmer['haystack'] >
	>
	type $mol_view__sub_eve_app_demo_4 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	...
	type $mol_view__sub_eve_app_demo_6 = $mol_type_enforce<
		...
		ReturnType< $mol_view['sub'] >
	>
	type $mol_dimmer__haystack_eve_app_demo_7 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_dimmer['haystack'] >
	>
	type $mol_view__sub_eve_app_demo_8 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_dimmer__haystack_eve_app_demo_9 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_dimmer['haystack'] >
	>
	...
	type $mol_view__sub_eve_app_demo_11 = $mol_type_enforce<
		...
		ReturnType< $mol_view['sub'] >
	>
	type $mol_dimmer__haystack_eve_app_demo_12 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_dimmer['haystack'] >
	>
	...
	type $mol_view__sub_eve_app_demo_14 = $mol_type_enforce<
		...
		ReturnType< $mol_view['sub'] >
	>
	type $mol_dimmer__haystack_eve_app_demo_15 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_dimmer['haystack'] >
	>
	...
	type $mol_view__sub_eve_app_demo_17 = $mol_type_enforce<
		...
		ReturnType< $mol_view['sub'] >
	>
	type $mol_row__sub_eve_app_demo_18 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_row['sub'] >
	>
	type $mol_list__rows_eve_app_demo_19 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_list['rows'] >
	>
	type $mol_dimmer__haystack_eve_app_demo_20 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_dimmer['haystack'] >
	>
	type $mol_view__sub_eve_app_demo_21 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_string__hint_eve_app_demo_22 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_string['hint'] >
	>
	type $mol_string__value_eve_app_demo_23 = $mol_type_enforce<
		ReturnType< $eve_app_demo['demo_name'] >
		,
		ReturnType< $mol_string['value'] >
	>
	type $mol_form_field__name_eve_app_demo_24 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_form_field['name'] >
	>
	type $mol_form_field__Content_eve_app_demo_25 = $mol_type_enforce<
		ReturnType< $eve_app_demo['Name_input'] >
		,
		ReturnType< $mol_form_field['Content'] >
	>
	type $mol_string__hint_eve_app_demo_26 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_string['hint'] >
	>
	type $mol_string__value_eve_app_demo_27 = $mol_type_enforce<
		ReturnType< $eve_app_demo['demo_email'] >
		,
		ReturnType< $mol_string['value'] >
	>
	type $mol_form_field__name_eve_app_demo_28 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_form_field['name'] >
	>
	type $mol_form_field__Content_eve_app_demo_29 = $mol_type_enforce<
		ReturnType< $eve_app_demo['Email_input'] >
		,
		ReturnType< $mol_form_field['Content'] >
	>
	type $mol_textarea__hint_eve_app_demo_30 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_textarea['hint'] >
	>
	type $mol_textarea__value_eve_app_demo_31 = $mol_type_enforce<
		ReturnType< $eve_app_demo['demo_message'] >
		,
		ReturnType< $mol_textarea['value'] >
	>
	type $mol_form_field__name_eve_app_demo_32 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_form_field['name'] >
	>
	type $mol_form_field__Content_eve_app_demo_33 = $mol_type_enforce<
		ReturnType< $eve_app_demo['Message_input'] >
		,
		ReturnType< $mol_form_field['Content'] >
	>
	type $mol_check_box__title_eve_app_demo_34 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_check_box['title'] >
	>
	type $mol_check_box__checked_eve_app_demo_35 = $mol_type_enforce<
		ReturnType< $eve_app_demo['demo_check1'] >
		,
		ReturnType< $mol_check_box['checked'] >
	>
	type $mol_check_box__title_eve_app_demo_36 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_check_box['title'] >
	>
	type $mol_check_box__checked_eve_app_demo_37 = $mol_type_enforce<
		ReturnType< $eve_app_demo['demo_check2'] >
		,
		ReturnType< $mol_check_box['checked'] >
	>
	type $mol_check_box__title_eve_app_demo_38 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_check_box['title'] >
	>
	type $mol_check_box__checked_eve_app_demo_39 = $mol_type_enforce<
		ReturnType< $eve_app_demo['demo_check3'] >
		,
		ReturnType< $mol_check_box['checked'] >
	>
	type $mol_row__sub_eve_app_demo_40 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_row['sub'] >
	>
	type $mol_button_major__title_eve_app_demo_41 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_major['title'] >
	>
	type $mol_button_minor__title_eve_app_demo_42 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_minor['title'] >
	>
	type $mol_row__sub_eve_app_demo_43 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_row['sub'] >
	>
	type $mol_list__rows_eve_app_demo_44 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_list['rows'] >
	>
	type $mol_list__rows_eve_app_demo_45 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_list['rows'] >
	>
	type $mol_dimmer__haystack_eve_app_demo_46 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_dimmer['haystack'] >
	>
	type $mol_view__sub_eve_app_demo_47 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_dimmer__haystack_eve_app_demo_48 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_dimmer['haystack'] >
	>
	type $mol_dimmer__haystack_eve_app_demo_49 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_dimmer['haystack'] >
	>
	type $mol_dimmer__haystack_eve_app_demo_50 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_dimmer['haystack'] >
	>
	type $mol_row__sub_eve_app_demo_51 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_row['sub'] >
	>
	...
	type $mol_view__sub_eve_app_demo_57 = $mol_type_enforce<
		...
		ReturnType< $mol_view['sub'] >
	>
	type $mol_row__sub_eve_app_demo_58 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_row['sub'] >
	>
	...
	type $mol_view__sub_eve_app_demo_64 = $mol_type_enforce<
		...
		ReturnType< $mol_view['sub'] >
	>
	type $mol_row__sub_eve_app_demo_65 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_row['sub'] >
	>
	...
	type $mol_view__sub_eve_app_demo_71 = $mol_type_enforce<
		...
		ReturnType< $mol_view['sub'] >
	>
	type $mol_row__sub_eve_app_demo_72 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_row['sub'] >
	>
	type $mol_list__rows_eve_app_demo_73 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_list['rows'] >
	>
	type $mol_list__rows_eve_app_demo_74 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_list['rows'] >
	>
	type $mol_list__rows_eve_app_demo_75 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_list['rows'] >
	>
	export class $eve_app_demo extends $eve_page {
...
declare namespace $ {
	...
	type $mol_view__sub_eve_app_page_themer_colors_1 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_dimmer__haystack_eve_app_page_themer_colors_2 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_dimmer['haystack'] >
	>
	type $mol_view__sub_eve_app_page_themer_colors_3 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $eve_app_color__value_eve_app_page_themer_colors_4 = $mol_type_enforce<
		ReturnType< $eve_app_page_themer_colors['color_back'] >
		,
		ReturnType< $eve_app_color['value'] >
	>
	type $mol_form_field__name_eve_app_page_themer_colors_5 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_form_field['name'] >
	>
	type $mol_form_field__Content_eve_app_page_themer_colors_6 = $mol_type_enforce<
		ReturnType< $eve_app_page_themer_colors['Back_color'] >
		,
		ReturnType< $mol_form_field['Content'] >
	>
	type $eve_app_color__value_eve_app_page_themer_colors_7 = $mol_type_enforce<
		ReturnType< $eve_app_page_themer_colors['color_card'] >
		,
		ReturnType< $eve_app_color['value'] >
	>
	type $mol_form_field__name_eve_app_page_themer_colors_8 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_form_field['name'] >
	>
	type $mol_form_field__Content_eve_app_page_themer_colors_9 = $mol_type_enforce<
		ReturnType< $eve_app_page_themer_colors['Card_color'] >
		,
		ReturnType< $mol_form_field['Content'] >
	>
	type $eve_app_color__value_eve_app_page_themer_colors_10 = $mol_type_enforce<
		ReturnType< $eve_app_page_themer_colors['color_field'] >
		,
		ReturnType< $eve_app_color['value'] >
	>
	type $mol_form_field__name_eve_app_page_themer_colors_11 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_form_field['name'] >
	>
	type $mol_form_field__Content_eve_app_page_themer_colors_12 = $mol_type_enforce<
		ReturnType< $eve_app_page_themer_colors['Field_color'] >
		,
		ReturnType< $mol_form_field['Content'] >
	>
	type $eve_app_color__value_eve_app_page_themer_colors_13 = $mol_type_enforce<
		ReturnType< $eve_app_page_themer_colors['color_hover'] >
		,
		ReturnType< $eve_app_color['value'] >
	>
	type $mol_form_field__name_eve_app_page_themer_colors_14 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_form_field['name'] >
	>
	type $mol_form_field__Content_eve_app_page_themer_colors_15 = $mol_type_enforce<
		ReturnType< $eve_app_page_themer_colors['Hover_color'] >
		,
		ReturnType< $mol_form_field['Content'] >
	>
	type $mol_list__rows_eve_app_page_themer_colors_16 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_list['rows'] >
	>
	type $mol_dimmer__haystack_eve_app_page_themer_colors_17 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_dimmer['haystack'] >
	>
	type $mol_view__sub_eve_app_page_themer_colors_18 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $eve_app_color__value_eve_app_page_themer_colors_19 = $mol_type_enforce<
		ReturnType< $eve_app_page_themer_colors['color_text'] >
		,
		ReturnType< $eve_app_color['value'] >
	>
	type $mol_form_field__name_eve_app_page_themer_colors_20 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_form_field['name'] >
	>
	type $mol_form_field__Content_eve_app_page_themer_colors_21 = $mol_type_enforce<
		ReturnType< $eve_app_page_themer_colors['Text_color'] >
		,
		ReturnType< $mol_form_field['Content'] >
	>
	type $eve_app_color__value_eve_app_page_themer_colors_22 = $mol_type_enforce<
		ReturnType< $eve_app_page_themer_colors['color_shade'] >
		,
		ReturnType< $eve_app_color['value'] >
	>
	type $mol_form_field__name_eve_app_page_themer_colors_23 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_form_field['name'] >
	>
	type $mol_form_field__Content_eve_app_page_themer_colors_24 = $mol_type_enforce<
		ReturnType< $eve_app_page_themer_colors['Shade_color'] >
		,
		ReturnType< $mol_form_field['Content'] >
	>
	type $eve_app_color__value_eve_app_page_themer_colors_25 = $mol_type_enforce<
		ReturnType< $eve_app_page_themer_colors['color_line'] >
		,
		ReturnType< $eve_app_color['value'] >
	>
	type $mol_form_field__name_eve_app_page_themer_colors_26 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_form_field['name'] >
	>
	type $mol_form_field__Content_eve_app_page_themer_colors_27 = $mol_type_enforce<
		ReturnType< $eve_app_page_themer_colors['Line_color'] >
		,
		ReturnType< $mol_form_field['Content'] >
	>
	type $eve_app_color__value_eve_app_page_themer_colors_28 = $mol_type_enforce<
		ReturnType< $eve_app_page_themer_colors['color_focus'] >
		,
		ReturnType< $eve_app_color['value'] >
	>
	type $mol_form_field__name_eve_app_page_themer_colors_29 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_form_field['name'] >
	>
	type $mol_form_field__Content_eve_app_page_themer_colors_30 = $mol_type_enforce<
		ReturnType< $eve_app_page_themer_colors['Focus_color'] >
		,
		ReturnType< $mol_form_field['Content'] >
	>
	type $mol_list__rows_eve_app_page_themer_colors_31 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_list['rows'] >
	>
	type $mol_dimmer__haystack_eve_app_page_themer_colors_32 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_dimmer['haystack'] >
	>
	type $mol_view__sub_eve_app_page_themer_colors_33 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $eve_app_color__value_eve_app_page_themer_colors_34 = $mol_type_enforce<
		ReturnType< $eve_app_page_themer_colors['color_control'] >
		,
		ReturnType< $eve_app_color['value'] >
	>
	type $mol_form_field__name_eve_app_page_themer_colors_35 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_form_field['name'] >
	>
	type $mol_form_field__Content_eve_app_page_themer_colors_36 = $mol_type_enforce<
		ReturnType< $eve_app_page_themer_colors['Control_color'] >
		,
		ReturnType< $mol_form_field['Content'] >
	>
	type $eve_app_color__value_eve_app_page_themer_colors_37 = $mol_type_enforce<
		ReturnType< $eve_app_page_themer_colors['color_current'] >
		,
		ReturnType< $eve_app_color['value'] >
	>
	type $mol_form_field__name_eve_app_page_themer_colors_38 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_form_field['name'] >
	>
	type $mol_form_field__Content_eve_app_page_themer_colors_39 = $mol_type_enforce<
		ReturnType< $eve_app_page_themer_colors['Current_color'] >
		,
		ReturnType< $mol_form_field['Content'] >
	>
	type $eve_app_color__value_eve_app_page_themer_colors_40 = $mol_type_enforce<
		ReturnType< $eve_app_page_themer_colors['color_special'] >
		,
		ReturnType< $eve_app_color['value'] >
	>
	type $mol_form_field__name_eve_app_page_themer_colors_41 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_form_field['name'] >
	>
	type $mol_form_field__Content_eve_app_page_themer_colors_42 = $mol_type_enforce<
		ReturnType< $eve_app_page_themer_colors['Special_color'] >
		,
		ReturnType< $mol_form_field['Content'] >
	>
	type $mol_list__rows_eve_app_page_themer_colors_43 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_list['rows'] >
	>
	type $mol_list__rows_eve_app_page_themer_colors_44 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_list['rows'] >
	>
	type $mol_scroll__sub_eve_app_page_themer_colors_45 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_scroll['sub'] >
	>
	type $mol_view__style_eve_app_page_themer_colors_46 = $mol_type_enforce<
		({ 
			'--mol_theme_back': ReturnType< $eve_app_page_themer_colors['color_back'] >,
			'--mol_theme_card': ReturnType< $eve_app_page_themer_colors['color_card'] >,
			'--mol_theme_field': ReturnType< $eve_app_page_themer_colors['color_field'] >,
			'--mol_theme_hover': ReturnType< $eve_app_page_themer_colors['color_hover'] >,
			'--mol_theme_text': ReturnType< $eve_app_page_themer_colors['color_text'] >,
			'--mol_theme_shade': ReturnType< $eve_app_page_themer_colors['color_shade'] >,
			'--mol_theme_line': ReturnType< $eve_app_page_themer_colors['color_line'] >,
			'--mol_theme_focus': ReturnType< $eve_app_page_themer_colors['color_focus'] >,
			'--mol_theme_control': ReturnType< $eve_app_page_themer_colors['color_control'] >,
			'--mol_theme_current': ReturnType< $eve_app_page_themer_colors['color_current'] >,
			'--mol_theme_special': ReturnType< $eve_app_page_themer_colors['color_special'] >,
		}) 
		,
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__sub_eve_app_page_themer_colors_47 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_scroll__sub_eve_app_page_themer_colors_48 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_scroll['sub'] >
	>
	export class $eve_app_page_themer_colors extends $mol_row {
		Controls_title_text( ): $mol_dimmer
		Controls_title( ): $mol_view
		Backgrouneve_title_text( ): $mol_dimmer
		Backgrouneve_title( ): $mol_view
		color_back( next?: string ): string
		Back_color( ): $eve_app_color
		Back_field( ): $mol_form_field
		color_card( next?: string ): string
		Card_color( ): $eve_app_color
		Card_field( ): $mol_form_field
		color_field( next?: string ): string
		Field_color( ): $eve_app_color
		Field_field( ): $mol_form_field
		color_hover( next?: string ): string
		Hover_color( ): $eve_app_color
		Hover_field( ): $mol_form_field
		Backgrouneve_section( ): $mol_list
		Text_title_text( ): $mol_dimmer
		Text_title( ): $mol_view
		color_text( next?: string ): string
		Text_color( ): $eve_app_color
		Text_field( ): $mol_form_field
		color_shade( next?: string ): string
		Shade_color( ): $eve_app_color
		Shade_field( ): $mol_form_field
		color_line( next?: string ): string
		Line_color( ): $eve_app_color
		Line_field( ): $mol_form_field
		color_focus( next?: string ): string
		Focus_color( ): $eve_app_color
...
declare namespace $ {
	...
	export class $eve_app_page_themer extends $eve_page {
		Colors( ): $eve_app_page_themer_colors
		title( ): string
		Head( ): any
		body( ): readonly(any)[]
	}
...
declare namespace $ {
	...
	type $mol_link_source__uri_eve_app_1 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_link_source['uri'] >
	>
	type $mol_link_source__style_eve_app_2 = $mol_type_enforce<
		({ 
			'alignItems': string,
		}) 
		,
		ReturnType< $mol_link_source['style'] >
	>
	type $mol_deck__items_eve_app_3 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_deck['items'] >
	>
	export class $eve_app extends $eve_page {
		Theme( ): $mol_theme_auto
		Sources( ): $mol_link_source
		Lights( ): $mol_lights_toggle
		Switch( ): ReturnType< ReturnType< $eve_app['Deck'] >['Switch'] >
		Content( ): ReturnType< ReturnType< $eve_app['Deck'] >['Content'] >
		Libraries( ): $eve_app_page_libraries
		Components_page( ): $eve_app_page_components
		Design_page( ): $eve_app_page_design
		Themer_page( ): $eve_app_page_themer
		plugins( ): readonly(any)[]
		title( ): string
		head( ): readonly(any)[]
		tools( ): readonly(any)[]
