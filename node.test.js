...
;
	($.$eve_page) = class $eve_page extends ($.$mol_page) {};
...
;
	($.$eve_surface) = class $eve_surface extends ($.$mol_view) {
		colors(next){
			if(next !== undefined) return next;
			return null;
		}
	...
	($mol_mem(($.$eve_surface.prototype), "colors"));
	($mol_mem(($.$eve_surface.prototype), "variant"));
	($mol_mem(($.$eve_surface.prototype), "interactive"));
	($mol_mem(($.$eve_surface.prototype), "size"));
	($mol_mem(($.$eve_surface.prototype), "state"));
...
(function ($) {
    var $$;
    (function ($$) {
        class $eve_surface extends $.$eve_surface {
        ...
        __decorate([
            $mol_mem
        ], $eve_surface.prototype, "state", null);
        __decorate([
            $mol_mem
        ], $eve_surface.prototype, "colors", null);
        __decorate([
            $mol_mem
        ], $eve_surface.prototype, "variant", null);
        __decorate([
            $mol_mem
        ], $eve_surface.prototype, "interactive", null);
        __decorate([
            $mol_mem
        ], $eve_surface.prototype, "size", null);
        $$.$eve_surface = $eve_surface;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
(function ($) {
    ...
    (function ($$) {
        ...
        function get_token(component, color, variant, part, modifier = 'enabled') {
            return `${TOKEN_PREFIX}${component}_${color}_${variant}_${part}_${modifier}`;
        }
        $$.get_token = get_token;
        function $eve_surface_get_token_surface(color, variant, part, modifier = 'enabled') {
        ...
        $$.get_token_size = get_token_size;
        function get_token_radius(size) {
            return `${TOKEN_PREFIX}surface_radius_${size}`;
        }
        $$.get_token_radius = get_token_radius;
        function get_token_border(size) {
            return size
                ? `${TOKEN_PREFIX}surface_size_${size}_border`
                : `${TOKEN_PREFIX}surface_border_width`;
        }
        $$.get_token_border = get_token_border;
        function get_token_surface_property(property) {
            return `${TOKEN_PREFIX}surface_${property}`;
        }
        $$.get_token_surface_property = get_token_surface_property;
        function var_token(token, fallback) {
...
(function ($) {
    var $$;
    (function ($$) {
        $mol_style_define($eve_page, {
            background: {
                color: $eve_surface_get_token_surface_level_var('low'),
            },
            boxShadow: 'none',
        });
    })($$ = $.$$ || ($.$$ = {}));
...
;
	($.$eve_app_page_libraries) = class $eve_app_page_libraries extends ($.$eve_page) {
		Content(){
			const obj = new this.$.$mol_text();
			(obj.text) = () => ("Libraries page - Coming soon...");
			return obj;
		}
		title(){
			return "Libraries";
	...
	($mol_mem(($.$eve_app_page_libraries.prototype), "Content"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem_key
        ], $eve_app_page_libraries.prototype, "spread_title", null);
        $$.$eve_app_page_libraries = $eve_app_page_libraries;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem
        ], $eve_flex.prototype, "direction", null);
        __decorate([
            $mol_mem
        ], $eve_flex.prototype, "justify_content", null);
        __decorate([
            $mol_mem
        ], $eve_flex.prototype, "align_items", null);
        __decorate([
            $mol_mem
        ], $eve_flex.prototype, "wrap", null);
        __decorate([
            $mol_mem
        ], $eve_flex.prototype, "gap", null);
        $$.$eve_flex = $eve_flex;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$eve_app_page_components_surface) = class $eve_app_page_components_surface extends ($.$eve_app_page_sb_page) {
		Hint(){
			const obj = new this.$.$mol_text();
		...
		Variant_select_value(next){
			if(next !== undefined) return next;
			return "soft";
		}
		Variant_select(){
			const obj = new this.$.$mol_select();
			(obj.dictionary) = () => ((this.variants()));
			(obj.value) = (next) => ((this.Variant_select_value(next)));
			return obj;
		}
		grid_cells(){
			return [];
		...
		Grid_cell(id){
			const obj = new this.$.$eve_surface();
			(obj.variant) = () => ((this.Variant_select_value()));
			(obj.colors) = () => ((this.grid_cell_color(id)));
			(obj.state) = () => ((this.grid_cell_state(id)));
			return obj;
		}
	};
	($mol_mem(($.$eve_app_page_components_surface.prototype), "Hint"));
	($mol_mem(($.$eve_app_page_components_surface.prototype), "Variant_select_value"));
	($mol_mem(($.$eve_app_page_components_surface.prototype), "Variant_select"));
	($mol_mem(($.$eve_app_page_components_surface.prototype), "Showcase_grid"));
	($mol_mem(($.$eve_app_page_components_surface.prototype), "Card"));
	($mol_mem(($.$eve_app_page_components_surface.prototype), "Grid_empty"));
	($mol_mem_key(($.$eve_app_page_components_surface.prototype), "Grid_column_header"));
	($mol_mem_key(($.$eve_app_page_components_surface.prototype), "Grid_row_header"));
	($mol_mem_key(($.$eve_app_page_components_surface.prototype), "Grid_cell"));
    ...
    (function ($$) {
        class $eve_app_page_components_surface extends $.$eve_app_page_components_surface {
            grid_cells() {
                ...
                $eve_surface.STATE_MODIFIERS.forEach(state => {
                    cells.push(this.Grid_column_header(state));
                });
                $eve_surface.COLORS.forEach(color => {
        ...
        __decorate([
            $mol_mem
        ], $eve_app_page_components_surface.prototype, "grid_cells", null);
        __decorate([
            $mol_mem_key
        ], $eve_app_page_components_surface.prototype, "grid_header_text", null);
        __decorate([
            $mol_mem_key
        ], $eve_app_page_components_surface.prototype, "grid_row_text", null);
        __decorate([
            $mol_mem_key
        ], $eve_app_page_components_surface.prototype, "grid_cell_color", null);
        __decorate([
            $mol_mem_key
        ], $eve_app_page_components_surface.prototype, "grid_cell_state", null);
        $$.$eve_app_page_components_surface = $eve_app_page_components_surface;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$hyoo_tree_edit) = class $hyoo_tree_edit extends ($.$mol_list) {
		...
		Item_type(id){
			...
			(obj.hint) = () => ("Type");
			(obj.value) = (next) => ((this.item_type(id, next)));
			(obj.enabled) = () => ((this.enabled()));
			return obj;
		}
		item_value(id, next){
		...
		Item_born(id){
			const obj = new this.$.$mol_button_minor();
			(obj.hint) = () => ("Add item");
			(obj.click) = (next) => ((this.item_born(id, next)));
			(obj.enabled) = () => ((this.enabled()));
			(obj.sub) = () => ([(this.Item_born_icon(id))]);
			return obj;
		}
		Item_delete_icon(id){
		...
		item_delete_self(id, next){
			if(next !== undefined) return next;
			return null;
		}
		Item_delete_self(id){
			const obj = new this.$.$mol_button_minor();
			(obj.click) = (next) => ((this.item_delete_self(id, next)));
			(obj.sub) = () => (["Disappear"]);
			return obj;
		}
		item_delete_tree(id, next){
			if(next !== undefined) return next;
			return null;
		}
		Item_delete_tree(id){
			const obj = new this.$.$mol_button_minor();
			(obj.click) = (next) => ((this.item_delete_tree(id, next)));
			(obj.sub) = () => (["Truncate"]);
			return obj;
		}
		Item_delete_options(id){
			const obj = new this.$.$mol_list();
			(obj.rows) = () => ([(this.Item_delete_self(id)), (this.Item_delete_tree(id))]);
			return obj;
		}
		Item_delete(id){
			const obj = new this.$.$mol_pick();
			(obj.hint) = () => ("Delete");
			(obj.trigger_enabled) = () => ((this.enabled()));
			(obj.trigger_content) = () => ([(this.Item_delete_icon(id))]);
			(obj.bubble_content) = () => ([(this.Item_delete_options(id))]);
			return obj;
		}
		item_row(id){
			return [
		...
		List(id){
			const obj = new this.$.$mol_list();
			(obj.rows) = () => ((this.list(id)));
			return obj;
		}
		Item(id){
			const obj = new this.$.$mol_list();
			(obj.rows) = () => ([(this.Item_row(id)), (this.List(id))]);
			return obj;
		}
		list(id){
			return [(this.Item("0"))];
	...
	($mol_mem_key(($.$hyoo_tree_edit.prototype), "Item_born"));
	($mol_mem_key(($.$hyoo_tree_edit.prototype), "Item_delete_icon"));
	($mol_mem_key(($.$hyoo_tree_edit.prototype), "item_delete_self"));
	($mol_mem_key(($.$hyoo_tree_edit.prototype), "Item_delete_self"));
	($mol_mem_key(($.$hyoo_tree_edit.prototype), "item_delete_tree"));
	($mol_mem_key(($.$hyoo_tree_edit.prototype), "Item_delete_tree"));
	($mol_mem_key(($.$hyoo_tree_edit.prototype), "Item_delete_options"));
	($mol_mem_key(($.$hyoo_tree_edit.prototype), "Item_delete"));
	($mol_mem_key(($.$hyoo_tree_edit.prototype), "Item_row"));
	($mol_mem_key(($.$hyoo_tree_edit.prototype), "List"));
	($mol_mem_key(($.$hyoo_tree_edit.prototype), "Item"));
	($mol_mem(($.$hyoo_tree_edit.prototype), "value"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem
        ], $hyoo_tree_edit.prototype, "value", null);
        __decorate([
            $mol_mem_key
        ], $hyoo_tree_edit.prototype, "item_row", null);
        __decorate([
            $mol_mem_key
        ], $hyoo_tree_edit.prototype, "item_kind", null);
        __decorate([
            $mol_mem_key
        ], $hyoo_tree_edit.prototype, "item_type", null);
        __decorate([
            $mol_mem_key
        ], $hyoo_tree_edit.prototype, "item_value", null);
        __decorate([
            $mol_mem_key
        ], $hyoo_tree_edit.prototype, "item_delete_self", null);
        __decorate([
            $mol_mem_key
        ], $hyoo_tree_edit.prototype, "item_delete_tree", null);
        __decorate([
            $mol_mem_key
        ], $hyoo_tree_edit.prototype, "item_born", null);
        __decorate([
            $mol_mem_key
        ], $hyoo_tree_edit.prototype, "list", null);
        $$.$hyoo_tree_edit = $hyoo_tree_edit;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
(function ($) {
    var $$;
    (function ($$) {
        $mol_style_define($hyoo_tree_edit, {
            List: {
                margin: {
                    left: $mol_gap.block,
                },
...
;
	($.$eve_button) = class $eve_button extends ($.$eve_flex) {
		label(){
			return "";
		}
		Label(){
	...
	($mol_mem(($.$eve_button.prototype), "clicks"));
	($mol_mem(($.$eve_button.prototype), "event_key_press"));
	($mol_mem(($.$eve_button.prototype), "colors"));
	($mol_mem(($.$eve_button.prototype), "variant"));
...
;
	($.$eve_app_page_sb_playground) = class $eve_app_page_sb_playground extends ($.$mol_book2) {
		...
		Editor_mode_toggle(){
			const obj = new this.$.$mol_check_icon();
			(obj.checked) = (next) => ((this.raw(next)));
			(obj.hint) = () => ("Toggle tree/text editor");
			return obj;
		}
		code_tab(next){
			if(next !== undefined) return next;
		...
		Source_tree(){
			const obj = new this.$.$hyoo_tree_edit();
			(obj.value) = (next) => ((this.source_tree(next)));
			return obj;
		}
		source_editor(){
			return [(this.Source_text()), (this.Source_tree())];
		}
		Source_panel(){
			const obj = new this.$.$eve_surface();
			(obj.colors) = () => ("lowest");
			(obj.sub) = () => ((this.source_editor()));
			return obj;
		}
		Props_placeholder(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ("Properties panel - coming soon");
			return obj;
		}
		Props_panel(){
			const obj = new this.$.$eve_surface();
			(obj.colors) = () => ("lowest");
			(obj.sub) = () => ([(this.Props_placeholder())]);
			return obj;
		}
		Code_tabs(){
		...
		Code_page(){
			...
			(obj.Head) = () => (null);
			(obj.title) = () => ("Code");
			(obj.tools) = () => ([(this.Editor_mode_toggle())]);
			(obj.body) = () => ([(this.Code_tabs())]);
			return obj;
		}
		component_name(){
	...
	($mol_mem(($.$eve_app_page_sb_playground.prototype), "raw"));
	($mol_mem(($.$eve_app_page_sb_playground.prototype), "Editor_mode_toggle"));
	($mol_mem(($.$eve_app_page_sb_playground.prototype), "code_tab"));
	...
	($mol_mem(($.$eve_app_page_sb_playground.prototype), "Source_tree"));
	($mol_mem(($.$eve_app_page_sb_playground.prototype), "Source_panel"));
	($mol_mem(($.$eve_app_page_sb_playground.prototype), "Props_placeholder"));
	($mol_mem(($.$eve_app_page_sb_playground.prototype), "Props_panel"));
	($mol_mem(($.$eve_app_page_sb_playground.prototype), "Code_tabs"));
    ...
    (function ($$) {
        class $eve_app_page_sb_playground extends $.$eve_app_page_sb_playground {
            ...
            live_component_code() {
                ...
                const js_code = this.$.$mol_tree2_text_to_string_mapped_js(this.$.$mol_tree2_js_to_text(this.$.$mol_view_tree2_to_js(tree)));
                return js_code;
            }
            Live_component() {
                try {
                    ...
                    const DynamicClass = this.$[componentName];
                    if (!DynamicClass) {
            ...
            customize_live_component(instance) {
                return instance;
            }
        }
        __decorate([
            $mol_mem
        ], $eve_app_page_sb_playground.prototype, "code_tab", null);
        __decorate([
            $mol_mem
        ], $eve_app_page_sb_playground.prototype, "raw", null);
        __decorate([
            $mol_mem
        ], $eve_app_page_sb_playground.prototype, "source_editor", null);
        __decorate([
            $mol_mem
        ], $eve_app_page_sb_playground.prototype, "source", null);
        __decorate([
            $mol_mem
        ], $eve_app_page_sb_playground.prototype, "source_tree", null);
        __decorate([
            $mol_mem
        ], $eve_app_page_sb_playground.prototype, "live_component_code", null);
        __decorate([
            $mol_mem
        ], $eve_app_page_sb_playground.prototype, "Live_component", null);
        $$.$eve_app_page_sb_playground = $eve_app_page_sb_playground;
    })($$ = $_1.$$ || ($_1.$$ = {}));
})($ || ($ = {}));
...
;
	($.$eve_app_page_components_flex) = class $eve_app_page_components_flex extends ($.$eve_app_page_sb_page) {
		Playground(){
	...
	($mol_mem(($.$eve_app_page_components_flex.prototype), "Playground"));
	($mol_mem_key(($.$eve_app_page_components_flex.prototype), "Showcase_cell"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        $$.$eve_app_page_components_flex = $eve_app_page_components_flex;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
(function ($) {
    ...
    (function ($$) {
        ...
        $mol_style_define($eve_app_page_components_flex, {});
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));

;
	($.$mol_icon_karate) = class $mol_icon_karate extends ($.$mol_icon) {
		path(){
			return "M19.8 2L11.6 8.7L10.39 7.66L14 5.58L9.41 1L8 2.41L10.74 5.15L5 8.46L3.81 12.75L6.27 17L8 16L5.97 12.5L6.32 11.18L9.5 13L10 22H12L12.5 12L21 3.4L19.8 2M5 3C6.11 3 7 3.9 7 5S6.11 7 5 7 3 6.11 3 5 3.9 3 5 3Z";
		}
	};
...
;
	($.$eve_app_page_components_button) = class $eve_app_page_components_button extends ($.$eve_app_page_sb_page) {
		Playground(){
			const obj = new this.$.$eve_app_page_sb_playground();
			(obj.component_name) = () => ("Live_button");
			(obj.default_source) = () => ("Live_button $eve_button\n\t- Edit values of Button component\n\tcolors \\primary\n\tvariant \\solid\n\tsize \\m\n\tlabel \\Click Me!\n\tsub /\n\t\t<= Icon $mol_icon_karate\n\t\t^\n");
			return obj;
		}
		Overview_page(){
...
(function ($) {
    var $$;
    (function ($$) {
        class $eve_app_page_components_button extends $.$eve_app_page_components_button {
        }
        $$.$eve_app_page_components_button = $eve_app_page_components_button;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
(function ($) {
    var $$;
    (function ($$) {
        $mol_style_define($eve_app_page_components_button, {});
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$eve_segmented) = class $eve_segmented extends ($.$eve_selection_single) {
		...
		Options_container(){
			const obj = new this.$.$eve_flex();
			(obj.sub) = () => ([(this.Plate()), ...(this.segments())]);
			return obj;
		}
		variant(){
			return "solid";
...
(function ($) {
    ...
    (function ($$) {
        class $eve_app_page_components extends $.$eve_app_page_components {
            ...
            size_rows() {
                return $eve_surface.SIZES.map(size => this.Size_row(size));
            }
            size_surfaces(size) {
                return $eve_surface.COLORS.map(color => this.Surface_cell(`${color}__${size}`));
            }
            surface_color(id) {
        ...
        __decorate([
            $mol_mem_key
        ], $eve_app_page_components.prototype, "spread_title", null);
        __decorate([
            $mol_mem
        ], $eve_app_page_components.prototype, "size_rows", null);
        __decorate([
            $mol_mem_key
        ], $eve_app_page_components.prototype, "size_surfaces", null);
        __decorate([
            $mol_mem_key
        ], $eve_app_page_components.prototype, "surface_color", null);
        __decorate([
            $mol_mem_key
        ], $eve_app_page_components.prototype, "surface_interactive", null);
        __decorate([
            $mol_mem_key
        ], $eve_app_page_components.prototype, "grid_header_text", null);
        __decorate([
            $mol_mem_key
        ], $eve_app_page_components.prototype, "grid_row_text", null);
        __decorate([
            $mol_mem_key
        ], $eve_app_page_components.prototype, "Grid_cell", null);
        $$.$eve_app_page_components = $eve_app_page_components;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	...
	($mol_mem(($.$eve_app_page_design.prototype), "Content"));
...
(function ($) {
    var $$;
    (function ($$) {
        class $eve_app_page_design extends $.$eve_app_page_design {
        }
        $$.$eve_app_page_design = $eve_app_page_design;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$eve_app_color) = class $eve_app_color extends ($.$mol_view) {
		Input(){
			const obj = new this.$.$mol_string();
			(obj.value) = (next) => ((this.value(next)));
			return obj;
		...
		attr(){
			return {...(super.attr()), "eve_themer_color": ""};
		}
		sub(){
			return [(this.Input()), (this.Picker_wrapper())];
		}
	};
	($mol_mem(($.$eve_app_color.prototype), "Input"));
	($mol_mem(($.$eve_app_color.prototype), "picker_input"));
	($mol_mem(($.$eve_app_color.prototype), "Picker"));
	($mol_mem(($.$eve_app_color.prototype), "Picker_wrapper"));
	($mol_mem(($.$eve_app_color.prototype), "value"));
...
(function ($) {
    var $$;
    (function ($$) {
        class $eve_app_color extends $.$eve_app_color {
            hex_value() {
        ...
        __decorate([
            $mol_mem
        ], $eve_app_color.prototype, "hex_value", null);
        __decorate([
            $mol_mem
        ], $eve_app_color.prototype, "Picker", null);
        $$.$eve_app_color = $eve_app_color;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$eve_app_demo) = class $eve_app_demo extends ($.$eve_page) {
		Settings(){
			const obj = new this.$.$mol_button_minor();
			(obj.title) = () => ("Settings");
			return obj;
		...
		Careve_title(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Careve_title_text())]);
			return obj;
		}
		Card1_title(){
			const obj = new this.$.$mol_dimmer();
		...
		Careve_section(){
			const obj = new this.$.$mol_list();
			(obj.rows) = () => ([(this.Careve_title()), (this.Careve_row())]);
			return obj;
		}
		Forms_title_text(){
			const obj = new this.$.$mol_dimmer();
	...
	($mol_mem(($.$eve_app_demo.prototype), "Settings"));
	($mol_mem(($.$eve_app_demo.prototype), "Profile"));
	($mol_mem(($.$eve_app_demo.prototype), "Welcome_title_text"));
	($mol_mem(($.$eve_app_demo.prototype), "Welcome_title"));
	($mol_mem(($.$eve_app_demo.prototype), "Welcome_text"));
	($mol_mem(($.$eve_app_demo.prototype), "Welcome_section"));
	($mol_mem(($.$eve_app_demo.prototype), "Careve_title_text"));
	($mol_mem(($.$eve_app_demo.prototype), "Careve_title"));
	($mol_mem(($.$eve_app_demo.prototype), "Card1_title"));
	($mol_mem(($.$eve_app_demo.prototype), "Card1_text"));
	($mol_mem(($.$eve_app_demo.prototype), "Card1"));
	($mol_mem(($.$eve_app_demo.prototype), "Card2_title"));
	($mol_mem(($.$eve_app_demo.prototype), "Card2_text"));
	($mol_mem(($.$eve_app_demo.prototype), "Card2"));
	($mol_mem(($.$eve_app_demo.prototype), "Card3_title"));
	($mol_mem(($.$eve_app_demo.prototype), "Card3_text"));
	($mol_mem(($.$eve_app_demo.prototype), "Card3"));
	($mol_mem(($.$eve_app_demo.prototype), "Careve_row"));
	($mol_mem(($.$eve_app_demo.prototype), "Careve_section"));
	($mol_mem(($.$eve_app_demo.prototype), "Forms_title_text"));
	($mol_mem(($.$eve_app_demo.prototype), "Forms_title"));
	($mol_mem(($.$eve_app_demo.prototype), "demo_name"));
	($mol_mem(($.$eve_app_demo.prototype), "Name_input"));
	($mol_mem(($.$eve_app_demo.prototype), "Name_field"));
	($mol_mem(($.$eve_app_demo.prototype), "demo_email"));
	($mol_mem(($.$eve_app_demo.prototype), "Email_input"));
	($mol_mem(($.$eve_app_demo.prototype), "Email_field"));
	($mol_mem(($.$eve_app_demo.prototype), "demo_message"));
	($mol_mem(($.$eve_app_demo.prototype), "Message_input"));
	($mol_mem(($.$eve_app_demo.prototype), "Message_field"));
	($mol_mem(($.$eve_app_demo.prototype), "demo_check1"));
	($mol_mem(($.$eve_app_demo.prototype), "Check1"));
	($mol_mem(($.$eve_app_demo.prototype), "demo_check2"));
	($mol_mem(($.$eve_app_demo.prototype), "Check2"));
	($mol_mem(($.$eve_app_demo.prototype), "demo_check3"));
	($mol_mem(($.$eve_app_demo.prototype), "Check3"));
	($mol_mem(($.$eve_app_demo.prototype), "Options_row"));
	($mol_mem(($.$eve_app_demo.prototype), "Submit_button"));
	($mol_mem(($.$eve_app_demo.prototype), "Cancel_button"));
	($mol_mem(($.$eve_app_demo.prototype), "Buttons_row"));
	($mol_mem(($.$eve_app_demo.prototype), "Form_demo"));
	($mol_mem(($.$eve_app_demo.prototype), "Forms_section"));
	($mol_mem(($.$eve_app_demo.prototype), "Table_title_text"));
	($mol_mem(($.$eve_app_demo.prototype), "Table_title"));
	($mol_mem(($.$eve_app_demo.prototype), "Header1"));
	($mol_mem(($.$eve_app_demo.prototype), "Header2"));
	($mol_mem(($.$eve_app_demo.prototype), "Header3"));
	($mol_mem(($.$eve_app_demo.prototype), "Table_header"));
	($mol_mem(($.$eve_app_demo.prototype), "Row1_col1_text"));
	($mol_mem(($.$eve_app_demo.prototype), "Row1_col1"));
	($mol_mem(($.$eve_app_demo.prototype), "Row1_col2_text"));
	($mol_mem(($.$eve_app_demo.prototype), "Row1_col2"));
	($mol_mem(($.$eve_app_demo.prototype), "Row1_col3_text"));
	($mol_mem(($.$eve_app_demo.prototype), "Row1_col3"));
	($mol_mem(($.$eve_app_demo.prototype), "Table_row1"));
	($mol_mem(($.$eve_app_demo.prototype), "Row2_col1_text"));
	($mol_mem(($.$eve_app_demo.prototype), "Row2_col1"));
	($mol_mem(($.$eve_app_demo.prototype), "Row2_col2_text"));
	($mol_mem(($.$eve_app_demo.prototype), "Row2_col2"));
	($mol_mem(($.$eve_app_demo.prototype), "Row2_col3_text"));
	($mol_mem(($.$eve_app_demo.prototype), "Row2_col3"));
	($mol_mem(($.$eve_app_demo.prototype), "Table_row2"));
	($mol_mem(($.$eve_app_demo.prototype), "Row3_col1_text"));
	($mol_mem(($.$eve_app_demo.prototype), "Row3_col1"));
	($mol_mem(($.$eve_app_demo.prototype), "Row3_col2_text"));
	($mol_mem(($.$eve_app_demo.prototype), "Row3_col2"));
	($mol_mem(($.$eve_app_demo.prototype), "Row3_col3_text"));
	($mol_mem(($.$eve_app_demo.prototype), "Row3_col3"));
	($mol_mem(($.$eve_app_demo.prototype), "Table_row3"));
	($mol_mem(($.$eve_app_demo.prototype), "Table_demo"));
	($mol_mem(($.$eve_app_demo.prototype), "Table_section"));
	($mol_mem(($.$eve_app_demo.prototype), "Demo_content"));
...
;
	($.$eve_app_page_themer_colors) = class $eve_app_page_themer_colors extends ($.$mol_row) {
		Controls_title_text(){
			const obj = new this.$.$mol_dimmer();
			return obj;
		}
		...
		Backgrouneve_title(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Backgrouneve_title_text())]);
			return obj;
		}
		color_back(next){
			if(next !== undefined) return next;
		...
		Back_color(){
			const obj = new this.$.$eve_app_color();
		...
		Backgrouneve_section(){
			const obj = new this.$.$mol_list();
			(obj.rows) = () => ([
				(this.Backgrouneve_title()), 
				(this.Back_field()), 
				(this.Card_field()), 
				(this.Field_field()), 
				(this.Hover_field())
		...
		Demo_site(){
			const obj = new this.$.$eve_app_demo();
			return obj;
		}
		Preview_inner(){
			const obj = new this.$.$mol_view();
	...
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "Controls_title_text"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "Controls_title"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "Backgrouneve_title_text"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "Backgrouneve_title"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "color_back"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "Back_color"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "Back_field"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "color_card"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "Card_color"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "Card_field"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "color_field"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "Field_color"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "Field_field"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "color_hover"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "Hover_color"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "Hover_field"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "Backgrouneve_section"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "Text_title_text"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "Text_title"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "color_text"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "Text_color"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "Text_field"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "color_shade"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "Shade_color"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "Shade_field"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "color_line"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "Line_color"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "Line_field"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "color_focus"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "Focus_color"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "Focus_field"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "Text_section"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "Controls_section_title_text"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "Controls_section_title"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "color_control"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "Control_color"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "Control_field"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "color_current"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "Current_color"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "Current_field"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "color_special"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "Special_color"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "Special_field"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "Controls_section"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "Controls_inner"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "Controls"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "Demo_site"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "Preview_inner"));
	($mol_mem(($.$eve_app_page_themer_colors.prototype), "Preview"));
...
;
	($.$eve_app_page_themer) = class $eve_app_page_themer extends ($.$eve_page) {
		Colors(){
			const obj = new this.$.$eve_app_page_themer_colors();
			return obj;
		}
		title(){
			return "Themer";
	...
	($mol_mem(($.$eve_app_page_themer.prototype), "Colors"));
...
(function ($) {
    var $$;
    (function ($$) {
        class $eve_app_page_themer extends $.$eve_app_page_themer {
        }
        $$.$eve_app_page_themer = $eve_app_page_themer;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$eve_app) = class $eve_app extends ($.$eve_page) {
		Theme(){
		...
		Sources(){
			...
			(obj.uri) = () => ("https://github.com/best-online-games/eve");
		...
		Libraries(){
			const obj = new this.$.$eve_app_page_libraries();
			return obj;
		}
		Components_page(){
			const obj = new this.$.$eve_app_page_components();
			return obj;
		}
		Design_page(){
			const obj = new this.$.$eve_app_page_design();
			return obj;
		}
		Themer_page(){
			const obj = new this.$.$eve_app_page_themer();
			return obj;
		}
		plugins(){
			return [(this.Theme())];
	...
	($mol_mem(($.$eve_app.prototype), "Theme"));
	($mol_mem(($.$eve_app.prototype), "Sources"));
	($mol_mem(($.$eve_app.prototype), "Lights"));
	($mol_mem(($.$eve_app.prototype), "Libraries"));
	($mol_mem(($.$eve_app.prototype), "Components_page"));
	($mol_mem(($.$eve_app.prototype), "Design_page"));
	($mol_mem(($.$eve_app.prototype), "Themer_page"));
	($mol_mem(($.$eve_app.prototype), "Deck"));
